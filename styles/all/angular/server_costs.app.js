...
function PsCtrl($scope) {
	...
	$scope.data = [
		...
		{'jahr': 2022, monat: 3, geber: 'LinkinPark, Juzzle', werbung: 0.11084044, trinkgeld: 0.88915956, status: 'finanziert'},
		{'jahr': 2022, monat: 4, geber: 'Juzzle', werbung: 0.06090134, trinkgeld: 0.93909866, status: 'finanziert'},
		{'jahr': 2022, monat: 5, geber: 'Juzzle, RPD, :) peda :)', werbung: 0.10475030, trinkgeld: 0.89524970, status: 'finanziert'},
		{'jahr': 2022, monat: 6, geber: ':) peda :)', werbung: 0.07917174, trinkgeld: 0.92082826, status: 'finanziert'},
		{'jahr': 2022, monat: 7, geber: ':) peda :)', werbung: 0.11814860, trinkgeld: 0.88185140, status: 'finanziert'},
		{'jahr': 2022, monat: 8, geber: ':) peda :)', werbung: 0.13276492, trinkgeld: 0.86723508, status: 'finanziert'},
		{'jahr': 2022, monat: 9, geber: ':) peda :)', werbung: 0.04376548, trinkgeld: 0.95623452, status: 'finanziert'},
		{'jahr': 2022, monat: 10, geber: ':) peda :)', werbung: 0.05846529, trinkgeld: 0.94153471, status: 'finanziert'},
		{'jahr': 2022, monat: 11, geber: ':) peda :)', werbung: 0.08526188, trinkgeld: 0.91473812, status: 'finanziert'},
		{'jahr': 2022, monat: 12, geber: '', werbung: 1.00000000, trinkgeld: 0.00000000, status: 'finanziert'},
		{'jahr': 2023, monat: 1, geber: ':) peda :)', werbung: 0.09135201, trinkgeld: 0.90864799, status: 'finanziert'},
		{'jahr': 2023, monat: 2, geber: ':) peda :)', werbung: 0.03654080, trinkgeld: 0.96345920, status: 'finanziert'},
		{'jahr': 2023, monat: 3, geber: ':) peda :)', werbung: 0.04263094, trinkgeld: 0.95736906, status: 'finanziert'},
	...
	$scope.geber = [
		...
		{name: 'ChainBreak', anzahl: 3, trinkgeld: 166.0},
		...
		{name: 'Lee', anzahl: 1, trinkgeld: 20.0},
